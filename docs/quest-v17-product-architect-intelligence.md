...
1. Read the base Quest files and only the v9-v17 sidecars relevant to the touched files, symbols, tests, runtime adapter, or product architecture decision.
...
The command refreshes Quest v9 coding intelligence plus the v10-v17 sidecars, including `strategic-next-actions.md`.

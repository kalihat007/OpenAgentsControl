...
1. Read the base Quest files and only the v9-v19 sidecars relevant to the touched files, symbols, tests, runtime adapter, evidence replay, deep-thinking review, idea-to-build plan, or product architecture decision.
...
The command refreshes Quest v9 coding intelligence plus the v10-v19 sidecars, including `strategic-next-actions.md`, `evidence-replay.md`, and `build-better-roadmap.md`.

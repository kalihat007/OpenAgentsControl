...
export function buildRuntimePrompt(options: RuntimeBridgeOptions): string {
  ...
  return [
    `Execute this OpenAgent Quest v8 control plane with Quest v9 coding intelligence, Coding Autopilot, Coding Execution, Verified Knowledgebase, and Semantic Repo Brain: ${objective}`,
    `Quest ID: ${questId}`,
    ...
    `Before execution, use interaction-memory.json, agent-memory.json, memory-graph.json, .oac/repo-wiki/, Quest v9 coding-intelligence sidecars, Coding Autopilot sidecars, Coding Execution sidecars, Verified Knowledgebase sidecars, and Semantic Repo Brain sidecars to avoid repeating work, reuse known context, and understand request/task/file/context relationships.`,
    ...
    `The CLI refreshes Quest v9 coding-intelligence, Coding Autopilot, Coding Execution, Verified Knowledgebase, and Semantic Repo Brain sidecars after Quest creation, file/context/validation events, coding events, and review/verify/complete lifecycle changes. Run oac quest-v9 when you need a fresh coding/autopilot/execution/verified-knowledgebase/semantic review snapshot.`,

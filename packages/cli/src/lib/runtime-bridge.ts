...
export function buildRuntimePrompt(options: RuntimeBridgeOptions): string {
  ...
  return [
    ...
    `Step budget guard: treat this runtime call as one bounded Quest execution cycle. Do not exhaustively read every optional sidecar before acting. Load quest.json, plan.json, events.ndjson, current user instructions, and only the v9-v20 sidecars directly needed for the touched files, symbols, tests, runtime adapter, evidence replay, deep thinking review, idea-to-build plan, delivery retrospective, self-improvement roadmap, or product-architecture recommendation.`,
    ...
    `Before execution, use interaction-memory.json, agent-memory.json, memory-graph.json, .oac/repo-wiki/, Quest v9 coding-intelligence sidecars, Coding Autopilot sidecars, Coding Execution sidecars, Verified Knowledgebase sidecars, Semantic Repo Brain sidecars, Temporal Memory sidecars, Intelligent Coding Team OS sidecars, Verified Coding Delivery OS sidecars, Product Architect Intelligence sidecars, Runtime Reliability + Evidence Replay OS sidecars, Deep Coding Collaboration OS sidecars, and Self-Improving Coding Team OS sidecars to avoid repeating work, reuse known context, understand request/task/file/context relationships, think deeply from idea to build, prove delivery readiness, avoid repeating broken commands, measure team improvement, and recommend the next product/architecture/build step.`,
    ...
    `The CLI refreshes Quest v9 coding-intelligence, Coding Autopilot, Coding Execution, Verified Knowledgebase, Semantic Repo Brain, Temporal Memory, Intelligent Coding Team OS, Verified Coding Delivery OS, Product Architect Intelligence, Runtime Reliability + Evidence Replay OS, Deep Coding Collaboration OS, and Self-Improving Coding Team OS sidecars after Quest creation, file/context/validation events, coding events, and review/verify/complete lifecycle changes. Run oac quest-v9 when you need a fresh coding/autopilot/execution/verified-knowledgebase/semantic/temporal/team/delivery/product-architect/runtime-reliability/deep-collaboration/self-improvement review snapshot, and run oac quest-replay <quest-id> to inspect replayable proof.`,

...
describe('runtime-bridge', () => {
  ...
  it('buildRuntimePrompt makes append-only control-plane write-back explicit', () => {
    ...
    expect(prompt).toContain('runtime-reliability-os.json')
    expect(prompt).toContain('command-failure-index.json')
    expect(prompt).toContain('timeout-policy.json')
    expect(prompt).toContain('claim-ledger.json')
    expect(prompt).toContain('runtime-doctor-report.json')
    expect(prompt).toContain('autonomous-recovery-plan.json')
    expect(prompt).toContain('flaky-command-memory.json')
    expect(prompt).toContain('evidence-replay.md')
    expect(prompt).toContain('deep-coding-collaboration-os.json')
    expect(prompt).toContain('deep-thinking-review.json')
    expect(prompt).toContain('idea-to-build-brief.json')
    expect(prompt).toContain('smarter-code-plan.json')
    expect(prompt).toContain('collaboration-board.json')
    expect(prompt).toContain('decision-tradeoff-matrix.json')
    expect(prompt).toContain('build-better-roadmap.md')
    expect(prompt).toContain('self-improving-coding-team-os.json')
    expect(prompt).toContain('coding-team-metrics.json')
    expect(prompt).toContain('delivery-retrospective.json')
    expect(prompt).toContain('learning-feedback-loop.json')
    ...
    expect(prompt).toContain('claim-ledger proof')
    expect(prompt).toContain('oac quest-replay')

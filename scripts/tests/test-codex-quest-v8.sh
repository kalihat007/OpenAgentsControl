...
pass "Codex adapter advertises Quest v8 adaptive protocol and Quest v9-v20 coding intelligence"
...
NODE
pass "Quest v8 artifact created with codex runtime and Quest v9-v20 sidecars"

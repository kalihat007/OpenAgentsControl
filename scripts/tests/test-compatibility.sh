...
if curl -fsSL --max-time 5 https://raw.githubusercontent.com/kalihat007/OpenAgentsControl/main/README.md > /dev/null 2>&1; then
...
echo "  curl -fsSL https://raw.githubusercontent.com/kalihat007/OpenAgentsControl/main/install.sh | bash"
echo ""

...
runtime-reliability-os.json # v18: runtime reliability, claim proof, and recovery rollup
command-failure-index.json # v18: failed-command fingerprints and known fixes
timeout-policy.json       # v18: command timeout policy including Kimi timeout guidance
claim-ledger.json         # v18: verified/inferred/missing/blocked completion claims
runtime-doctor-report.json # v18: Kimi/OpenCode/Codex/Claude runtime health checks
autonomous-recovery-plan.json # v18: retry/split/block recovery actions
flaky-command-memory.json # v18: repeated/flaky command memory
evidence-replay.md        # v18: human-readable replayable proof bundle
deep-coding-collaboration-os.json # v19: deep coding collaboration rollup
deep-thinking-review.json # v19: hard questions, assumptions, reasoning checks
idea-to-build-brief.json  # v19: user idea, product goal, build slices, checkpoints
smarter-code-plan.json    # v19: code quality moves and validation strategy
collaboration-board.json  # v19: user/agent/expert decisions and commitments
decision-tradeoff-matrix.json # v19: scope, validation, and collaboration tradeoffs
build-better-roadmap.md   # v19: readable build-better next steps
self-improving-coding-team-os.json # v20: Self-Improving Coding Team OS rollup
coding-team-metrics.json  # v20: delivery/quality/collaboration/learning/runtime scorecard
delivery-retrospective.json # v20: wins, issues, evidence gaps, and lessons
learning-feedback-loop.json # v20: feedback policy and promotion review signals
improvement-backlog.json  # v20: prioritized coding-team improvements
skill-evolution-candidates.json # v20: approval-gated skill evolution candidates
self-improvement-roadmap.md # v20: readable self-improvement roadmap
predictive-engineering-os.json # v21: Predictive Engineering OS rollup
intent-architecture-compiler.json # v21: requirements, invariants, surfaces, proof, assumptions
change-simulation-engine.json # v21: touched surfaces, blast radius, runtime impact, mitigations
risk-forecast-score.json # v21: hallucination/regression/timeout/knowledge/drift risk
implementation-path-ranking.json # v21: ranked implementation strategies and selected path
test-intelligence-planner.json # v21: required tests, runtime parity, missing tests
proof-contract.json # v21: done claims, evidence, blockers, completion policy
architecture-drift-detector.json # v21: protected contracts and drift signals
context-freshness-gate.json # v21: repo wiki, semantic brain, docs, and web freshness
predictive-timeout-guard.json # v21: Kimi/shell timeout and max-step guard
predictive-engineering-roadmap.md # v21: readable predictive engineering roadmap
.oac/repo-wiki/            # project-level living repo wiki
```

Runtimes append progress to `events.ndjson`; they do not rewrite `quest.json`. Use `oac quest-status` to list or inspect the reconciled run state, `oac quest-resume <quest-id>` to print OpenCode, Kimi, Claude, and Codex resume commands, `oac quest-v9 <quest-id>` to refresh coding intelligence plus the v12 Verified Knowledgebase, v13 Semantic Repo Brain, v14 Temporal Memory, v15 Intelligent Coding Team OS, v16 Verified Coding Delivery OS, v17 Product Architect Intelligence, v18 Runtime Reliability + Evidence Replay OS, v19 Deep Coding Collaboration OS, v20 Self-Improving Coding Team OS, and v21 Predictive Engineering OS, `oac quest-replay <quest-id>` to inspect replayable proof, and `oac runtime-doctor --runtime kimi` to check runtime health before Kimi release-ready claims. Resume does not change models; OpenAgent continues with the selected runtime model.
